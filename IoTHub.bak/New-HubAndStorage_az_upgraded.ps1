...
"@
    ...
    $deployment = New-AzResourceGroupDeployment -Name $deploymentName -ResourceGroupName $resourceGroup.ResourceGroupName -TemplateFile '.\HubAndStorage.json' -TemplateParameterObject $params
...
$subName = Get-AzSubscription -SubscriptionId $SubscriptionId
